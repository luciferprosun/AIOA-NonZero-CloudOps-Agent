"""Deny and record any non-loopback socket attempt in the fixed W4 child."""
...
_AUDIT_PATH_ENV: Final = "AIOA_W4_EGRESS_AUDIT_PATH"
...
def _deny_external(address: object) -> None:
    ...
    if audit_path:
        ...
        try:
            ...
            os.close(descriptor)
    raise RuntimeError("W4_EXTERNAL_EGRESS_DENIED")
