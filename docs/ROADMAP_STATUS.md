...
- NEXT_MACRO_STEP = B4_RELIABILITY_SECURITY_OBSERVABILITY_EVIDENCE_HARDENING
...
- The judge UI is loopback/single-operator only; public-host abuse controls, bounded soak evidence,
  and an explicit provider-egress allowlist belong to B4.
